...
node 'node-mojo.vbox.tld' inherits basenode {
    ...
    class { vb_install_debs : debs => [ "curl", "evince", "wdiff", "build-essential" ] }
...
node 'node-ruby.vbox.tld' inherits basenode {
    ...
    # Packages without any special configurations
    class { vb_install_debs : debs => [ "rubygems", "ruby-json", "ruby-net-http-persistent", "curl", "evince", "wdiff", "build-essential" ] }
...
node 'node-python.vbox.tld' inherits basenode {
    ...
    # Packages without any special configurations
    class { vb_install_debs : debs => [ "curl", "evince", "wdiff", "pyflakes", "python-sphinx", "sphinx-doc", "build-essential" ] }
...
node 'node-cobol.vbox.tld' inherits basenode {
    ...
    # Packages without any special configurations
    class { vb_install_debs : debs => [ "eclipse", "rubygems", "ruby-json", "ruby-net-http-persistent", "build-essential" ] }
...
node 'node-java.vbox.tld' inherits basenode {
    ...
    class { vb_install_debs : debs => [ "eclipse", "build-essential" ] }
...
node 'node-sid.vbox.tld' inherits basenode {
    ...
    # Packages without any special configurations
    class { vb_install_debs : debs => [ "patchutils", "quilt", "build-essential" ] }
